...
execfile("../python/auxillary_functions_L1HPSPFTau.py") ## loading all classes and functions needed
...
def load_data(
    ...
    for folderName in keys : ## Loop over file keys
        ...
        if (bdtType != None):
            ...
            procP1=glob.glob(inputPath+"/"+"bdt_test_L1HPSPFTauAnalyzer_"+folderName+"_GiovanniData_20191121_3*.root") ## Path to list of files given using *
            list=procP1
            print list
        else:
