...
## python sklearn_Xgboost_evtLevel_TallinnL1Trigger.py --channel L1HPSPFTau --variables testVars --doXML True --bdtType default --ntrees 1000 --treeDeph 2 --lr 0.01 --mcw 1 --FlattenDF True
...
execfile("../python/data_manager_L1HPSPFTau.py")

from optparse import OptionParser
parser = OptionParser()

parser.add_option("--channel ", type="string", dest="channel", help="The ones whose variables implemented now are:\n   - L1HPSPFTau\n It will create a local folder and store the report*/xml", default='L1HPSPFTau')
...
if 'L1HPSPFTau' in channel :  execfile("../cards/info_L1HPSPFTaus.py")
